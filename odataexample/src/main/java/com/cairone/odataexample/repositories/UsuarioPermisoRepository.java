...
public interface UsuarioPermisoRepository extends JpaRepository<UsuarioPermisoEntity, UsuarioPermisoPKEntity>,
		QueryDslPredicateExecutor<UsuarioPermisoEntity> {
